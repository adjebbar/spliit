      ...
      <section className="py-16 md:py-24 lg:py-32">
        <div className="container flex max-w-screen-md flex-col items-center gap-4 text-center">
          <h1 className="!leading-none font-bold text-3xl sm:text-5xl md:text-6xl lg:text-7xl landing-header py-2">
            Partager <strong>vos dépenses</strong> <br /> avec <strong>les amis </strong>{' '}
            & <strong>Famille</strong>
          </h1>
          <p className="max-w-[42rem] leading-normal text-muted-foreground sm:text-xl sm:leading-8">
            Bienvenue dans votre nouvelle <strong>Spliit</strong> instance! <br />
           // Customize this page by editing <em>src/app/page.tsx</em>.
          </p>
          <div className="flex gap-2">
            <Button asChild>
              <Link href="/groups">Aller dans les groupes</Link>
            </Button>
